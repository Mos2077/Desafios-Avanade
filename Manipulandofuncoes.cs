...
class Program
{
    ...
    static double CalcularPegadaDeCarbono(double kmPorDia, int horasEletronicos, int quantRefeicoes)
    {
      return ((kmPorDia * 365 * 0.2) + (horasEletronicos * 0.1) + (quantRefeicoes * 0.5)); 
    }
}